  ...
  function Ra(e17, t2, n2) {
    ...
    function a2(a3, o2, s2) {
      ...
      if (d2 === void 0 || d2.count !== u2) {
        let v2 = function() {
          g2.dispose(), r2.delete(o2), o2.removeEventListener(`dispose`, v2);
        };
        ...
        o2.addEventListener(`dispose`, v2);
      }
...
void main() {
  ...
  function Gs(e17, t2) {
    ...
    function me2(t3, n3, r3, i3, a3, o3, s3, c3, l3, u3) {
      ...
      a3 ||= n3, o3 ||= r3, s3 ||= i3, (n3 !== _2 || a3 !== b2) && (e17.blendEquationSeparate(fe2[n3], fe2[a3]), _2 = n3, b2 = a3), (r3 !== v2 || i3 !== y2 || o3 !== x2 || s3 !== S2) && (e17.blendFuncSeparate(pe2[r3], pe2[i3], pe2[o3], pe2[s3]), v2 = r3, y2 = i3, x2 = o3, S2 = s3), (c3.equals(C2) === false || l3 !== w2) && (e17.blendColor(c3.r, c3.g, c3.b, l3), C2.copy(c3), w2 = l3), g2 = t3, T2 = false;
    }
    function I2(t3, n3) {
...
`);
  ...
  $.toggleHide = function() {
    ...
    var e17 = this.load;
    return e17.closed = this.closed, this.__rememberedObjects.length > 0 && (e17.preset = this.preset, e17.remembered ||= {}, e17.remembered[this.preset] = gl(this)), e17.folders = {}, Z.each(this.__folders, function(t2, n2) {
...
` };
  ...
  var N2 = class {
    ...
    initScene() {
      this.colorControls = { color1: this.theme === `dark` ? `#7a6cff` : `#2c64ed`, color2: this.theme === `dark` ? `#ff5e8a` : `#f84242`, color3: this.theme === `dark` ? `#ffc24d` : `#ffcf03` }, this.ringWidth = this.options.ringWidth || 0.107, this.ringWidth2 = this.options.ringWidth2 || 0.05, this.ringDisplacement = this.options.ringDisplacement || 0.15, this.initParticles(), this.options.gui && this.initGUI(), this.onLoaded();
    }
    initParticles() {
  ...
  document.addEventListener(`DOMContentLoaded`, () => {
    document.querySelectorAll(`[data-main-particles-component]`).forEach((e17) => {
      ...
      if (!t2) return;
      let inst = null, obs = null, raf = null, running = false, mq = null;
      function build() {
        let n2 = e17.getAttribute(`data-theme`) || `light`, r2 = parseFloat(e17.getAttribute(`data-ring-width`) || `0.15`), i2 = parseFloat(e17.getAttribute(`data-ring-width2`) || `0.05`), a2 = parseFloat(e17.getAttribute(`data-ring-displacement`) || `0.15`), o2 = parseInt(e17.getAttribute(`data-density`) || `200`);
        inst = new N2({ container: t2, theme: n2, particlesScale: parseFloat(e17.getAttribute(`data-particles-scale`) || `0.75`), density: o2, interactive: true, gui: new URLSearchParams(window.location.search).get(`gui`) === `true`, verbose: false, ringWidth: r2, ringWidth2: i2, ringDisplacement: a2 });
        try {
          inst.scene.background = null;
        } catch (err) {
        }
        obs = new IntersectionObserver((es2) => {
          es2.forEach((x2) => {
            running = x2.isIntersecting;
            x2.isIntersecting ? inst.resume() : inst.stop();
          });
      ...
      function destroy() {
        ...
        raf !== null && (cancelAnimationFrame(raf), raf = null);
        inst && (inst.kill(), inst = null);
      }
      function sync() {
        let dark = window.matchMedia && window.matchMedia(`(prefers-color-scheme: dark)`).matches, th = dark ? `dark` : `light`;
        if (e17.getAttribute(`data-theme`) !== th) {
          e17.setAttribute(`data-theme`, th);
          destroy();
          build();
        }
      }
      ...
      window.addEventListener(`beforeunload`, () => {
        try {
          mq && mq.removeEventListener(`change`, sync);
        } catch (err) {
        }
        ;
        destroy();
